    ...
    return (
        <div className="login-clean">
            ...
            <form onSubmit={(e)=>e.preventDefault()}>
                ...
                <div className="form-group"><input ref={email} className="form-control" type="text" name="email" placeholder="Email" /></div>
                <div className="form-group"><input ref={password} className="form-control" type="password" name="password" placeholder="Password" /></div>
                <div className="form-group"><button className="btn btn-primary btn-block" onClick={handleSignIn}>{isSignIn?'Sign In':'Sign Up'}</button><p style={{color :'red'}}>{errorMessage}</p></div>
